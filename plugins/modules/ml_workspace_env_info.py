...
DOCUMENTATION = r"""
---
module: ml_workspace_env_info
short_description: Get environment details for a Cloudera Machine Learning (CML) workspace
description:
  - Get environment details for a Cloudera Machine Learning (CML) workspace.
...
class MLWorkspaceEnvInfo(AnsibleModule):
...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            crn=dict(required=False, type="str", aliases=["project_crn"]),
            debug=dict(required=False, type="bool", default=False),
        ),
        supports_check_mode=True,
    )

    result = MLWorkspaceEnvInfo(module)
